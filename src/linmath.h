...
static inline void mat4x4_scale_aniso(mat4x4 M, 
                                      mat4x4 a, 
                                      float x, 
                                      float y, 
                                      float z) 
...
static inline void mat4x4_mul(mat4x4 M, 
                              mat4x4 a, 
                              mat4x4 b) 
{
    int k, r, c;
...
static inline void mat4x4_mul_vec4(vec4 r, 
                                   mat4x4 M, 
                                   vec4 v) 
{
    int i, j;
...
static inline void mat4x4_translate(mat4x4 T, 
                                    float x, 
                                    float y, 
                                    float z) 
{
...
static inline void mat4x4_translate_in_place(mat4x4 M, 
                                             float x, 
                                             float y, 
                                             float z) 
{
...
static inline void mat4x4_from_vec3_mul_outer(mat4x4 M, 
                                              vec3 a, 
                                              vec3 b) 
{
    int i, j;
...
static inline void mat4x4_rotate(mat4x4 R, 
                                 mat4x4 M, 
                                 float  x, 
                                 float  y, 
                                 float  z, 
...
static inline void mat4x4_rotate_X(mat4x4 Q, 
                                   mat4x4 M, 
                                   float angle) 
{
    float s = (float)sin(angle);
...
static inline void mat4x4_rotate_Y(mat4x4 Q, 
                                   mat4x4 M, 
                                   float angle) 
{
    float s = (float)sin(angle);
...
static inline void mat4x4_rotate_Z(mat4x4 Q, 
                                   mat4x4 M, 
                                   float angle) 
{
    float s = (float)sin(angle);
...
static inline void mat4x4_invert(mat4x4 T, mat4x4 M) 
{
    ...
    idet = 1.0f / (s[0] * c[5] - s[1] * c[4] + s[2] * c[3] + 
...
static inline void mat4x4_frustum(mat4x4 M, 
                                  float  l, 
                                  float  r, 
                                  float  b, 
                                  float  t, 
...
static inline void mat4x4_ortho(mat4x4 M, 
                                float  l, 
                                float  r, 
                                float  b, 
                                float  t, 
...
static inline void mat4x4_perspective(mat4x4 m, 
                                      float  y_fov, 
                                      float  aspect, 
                                      float  n, 
                                      float  f) 
